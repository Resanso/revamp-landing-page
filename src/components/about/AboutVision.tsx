...
export default function AboutVision() {
  return (
    <div className="relative w-full bg-gray-900 px-6 py-16 md:py-20 shadow-xl flex flex-col items-center justify-center text-center mt-24 mb-24">
      ...
      <div className="relative z-20 flex flex-col items-center max-w-4xl mx-auto">
        ...
        <p className="text-gray-200 text-lg md:text-[20px] font-normal leading-relaxed mb-10 max-w-5xl">
